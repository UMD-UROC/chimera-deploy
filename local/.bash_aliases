...
alias fgb='cdr && cd - && ros2 launch 5g_drone foxglove_bridge.launch.py # launch foxglove ros bridge'
...
alias uspi1='ccb && cdr && ros2 launch 5g_drone uas1.launch.py && cd -'
alias uspi2='ccb && cdr && ros2 launch 5g_drone uas2.launch.py && cd -'
alias uspi3='ccb && cdr && ros2 launch 5g_drone uas3.launch.py && cd -'
alias uspi3-thermal='ccb && cdr && ros2 launch 5g_drone uas3_thermal.launch.py && cd -'
alias uspi4='ccb && cdr && ros2 launch 5g_drone uas4.launch.py && cd -'
alias uspi4-thermal='ccb && cdr && ros2 launch 5g_drone uas4_thermal.launch.py && cd -'
alias uspi4-assess='ccb && cdr && ros2 launch 5g_drone uas4_assess.launch.py && cd -'
