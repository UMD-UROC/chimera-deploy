...
#TAGS+=("rgb1")
#PIPES+=("( rtspsrc location=rtsp://10.200.142.51:8900/live $common")

#TAGS+=("rgb2")
#PIPES+=("( rtspsrc location=rtsp://10.200.142.52:8900/live $common")

TAGS+=("rgb3")
PIPES+=("( rtspsrc location=rtsp://10.200.142.53:8554/rgb $common")

TAGS+=("thermal3")
PIPES+=("( rtspsrc location=rtsp://10.200.142.53:8554/thermal $common")

TAGS+=("rgb4")
PIPES+=("( rtspsrc location=rtsp://10.200.142.54:8554/rgb $common")

TAGS+=("thermal4")
PIPES+=("( rtspsrc location=rtsp://10.200.142.54:8554/thermal $common")
